<div class="form-group row">
    {!! Form::label('resource_type', 'Resource Type *', ['class' => 'col-md-4 col-form-label']) !!}
    <div class="col-md-6">
        {!! Form::select('resource_type', [0 => 'Vehicle', 1 => 'Commander', 2 => 'Police'], $value = null, ['class' => 'form-control', 'placeholder' => '- Select Option -', 'required' => true]) !!}
    </div>
</div>
<div class="form-group row" id="qty" style="display: none;">
    {!! Form::label('quantity', 'Quantity *', ['class' => 'col-md-4 col-form-label']) !!}
    <div class="col-md-6">
        {!! Form::number('quantity', $value = null, ['class' => 'form-control', 'placeholder' => 'Quantity', 'maxlength' => 20]) !!}
    </div>
</div>
<div class="form-group row vh" style="display: none;">
    {!! Form::label('vehicle_type_id', 'Vehicle Type *', ['class' => 'col-md-4 col-form-label']) !!}
    <div class="col-md-6">
...
<div class="form-group row vh" style="display: none;">
    {!! Form::label('vehicle_id', 'Vehicle *', ['class' => 'col-md-4 col-form-label']) !!}
    <div class="col-md-6">

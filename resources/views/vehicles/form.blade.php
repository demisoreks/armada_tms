...
<div class="form-group row">
    {!! Form::label('tracker_imei', 'Tracker IMEI', ['class' => 'col-md-2 col-form-label']) !!}
    <div class="col-md-4">
        {!! Form::text('tracker_imei', $value = null, ['class' => 'form-control', 'placeholder' => 'Tracker IMEI', 'maxlength' => 50]) !!}
    </div>
</div>
<div class="form-group row">
